...
const Dashboard = () => {
  return (
    <div className="flex flex-col min-h-screen">
      <h1 className="text-4xl font-bold mb-8 text-gray-300 text-center">Welcome to the Dashboard!</h1>
      <p className="text-center">You have successfully logged in with Google.</p>

      <div className="flex flex-grow w-full">
        {/* Left Section */}
        <div className="flex flex-col w-1/2 bg-blue-500 p-6">
        ...
        <div className="flex w-1/2 bg-green-500 p-6">
          <div className="w-1/2 pr-4">
            <h2 className="center text-2xl font-bold text-white mb-4">Market Stats</h2>
